...
<title>'.__('Wysija Subscription',WYSIJA).'</title>';
    ...
    function display($title="",$params,$echo=true,$iframe=false){
        ...
        if(!isset($params['preview']) or (isset($params['preview']) && $params['preview'] === false)) {
            ...
            $submitbutton=$listfields.'<input type="submit" '.$disabledSubmit.' class="wysija-submit wysija-submit-field" name="submit" value="'.esc_attr($params['submit']).'"/><span style="clear:both;"></span>';
