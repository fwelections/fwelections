...
//					$parent_post = get_post($parent_pid);
//					
//					$crumbs[] = '<a href="'.get_permalink($parent_pid).'" class="incsub_wiki_crumbs">'.translate($parent_post->post_title).'</a>';
//				}
//				
//				$crumbs[] = '<span class="incsub_wiki_crumbs">'.translate($post->post_title).'</span>';
//				
				//sort($crumbs);
				...
				foreach($children as $child) {
					$crumbs[] = '<a href="'.get_permalink($child->ID).'" class="incsub_wiki_crumbs">'.translate($child->post_title).'</a>';
				}
