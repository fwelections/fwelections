...
function slider_select($atts, $values, $current_value = null, $select_one = false, $unidimensional = false) {
    ...
    if($select_one){
        $select .= '<option value="" ' . ('' == $current_value ? 'selected="selected"' : '') . '>' . __('Select one', 'add-slider') . '</option>';
    }
    foreach ($values as $value => $title) {
        if($unidimensional === true){
            $value = $title;
        }
        $select .= '<option value="' . $value . '" ' . ($value == $current_value ? 'selected="selected"' : '') . '>' . __($title, 'add-slider') . '</option>';
    }
    $select .= '</select>';
    return $select;
}
...
?>
    ...
    ?>
                        <form action="" method="post" id="form-slider">
                            <div id="col-container">
                                <div id="col-right">
                                    <div id="poststuff">
                                        ...
                                        <div class="postbox">
                                            <h3><?php _e('Slider example', 'add-slider'); ?></h3>
                                            <div class="inside">
                                                <br/>
                                                <div id="slider-example">
                                <?php for ($i = 1; $i <= 5; $i++): ?>
                                    <img alt="" src="../wp-content/plugins/add-slider/example/slide-<?php echo $i; ?>.jpg" />
                                <?php endfor; ?>
                                </div>
                                <br/>
                            </div>
                          ...
                          <div class="postbox">
                              <h3><?php _e('Slider code', 'add-slider'); ?></h3>
                              <div class="inside">
                                  <?php _e('Use the following code to insert this slider in your template:','add-slider'); ?>
                                  <code style="padding:10px 10px; margin:9px; display:block; text-align:center;">
                                      <?php echo "&lt?php if(function_exists('add_slider')): add_slider('{$slider['name']}'); endif; ?&gt" ;?>
                                  </code>
                              </div>
                          </div>
                    </div>                                    
                        ...
                        <div class="postbox">
                            ...
                            <div class="inside">
                                <table class="form-table">
                                    <tbody>
                                        <tr>
                                            <th align="left"><label for="name"><?php _e('Name', 'add-slider'); ?>:</label></th>
                                            <td align="left"><input type="text" value="<?php echo $slider['name']; ?>" name="name" id="name" size="20"></td>
                                        </tr>
                                        <tr>
                                            <th align="left"><label for="width"><?php _e('Width', 'add-slider'); ?>:</label></th>
                                            <td align="left"><input type="text" value="<?php echo $slider['options']['width']; ?>" name="width" id="width" size="10"> px</td>
                                        </tr>
                                        <tr>
                                            <th align="left"><label for="height"><?php _e('Height', 'add-slider'); ?>:</label></th>
                                            <td align="left"><input type="text" value="<?php echo $slider['options']['height']; ?>" name="height" id="height" size="10"> px</td>
                                        </tr>                                        
                                        <tr>
                                            <th align="left"><label for="effect"><?php _e('Effect', 'add-slider'); ?>:</label></th>
                                            <td align="left"><?php echo slider_select(array('name' => 'effect', 'id' => 'effect', 'class' => 'examplified'), $add_slider->effects, $slider['effect']['effect'], true, true); ?></td>
                                        </tr>
                                        <tr>
                                        <th align="left"><label for="easing"><?php _e('Easing', 'add-slider'); ?>:</label></th>
                                        <td align="left"><?php echo slider_select(array('name' => 'easing', 'id' => 'easing', 'class' => 'examplified'), $add_slider->easings, $slider['effect']['easing'], true, true); ?></td>
                                        </tr>
                                                <tr>
                                                    <th align="left"><label for="frecuency"><?php _e('Frecuency', 'add-slider'); ?>:</label></th>
                                                    <td align="left"><input type="text" class="examplified" value="<?php echo $slider['effect']['frecuency']; ?>" name="frecuency" id="frecuency" size="10"> <?php _e('seconds', 'add-slider'); ?></td>
                                                </tr>
                                                <tr>
                                                    <th align="left"><label for="delay"><?php _e('Delay', 'add-slider'); ?>:</label></th>
                                                    <td align="left"><input type="text" class="examplified" value="<?php echo $slider['effect']['delay']; ?>" name="delay" id="delay" size="10"> <?php _e('seconds', 'add-slider'); ?></td>
                                                </tr>
                                                <tr>
                                                    <th align="left"><label for="before"><?php _e('onBefore function name', 'add-slider'); ?>:</label></th>
                                                    <td align="left"><input type="text" value="<?php echo $slider['effect']['before']; ?>" name="before" id="before"></td>
                                                </tr>

                                                <tr>
                                                    <th align="left"><label for="after"><?php _e('onAfter function name', 'add-slider'); ?>:</label></th>
    ...
    <?php $slider_elements = $add_slider->get_slider_elements($_GET['slider_id']); ?>
                                                <div class="tablenav">
                                                    <div class="alignleft actions">
                                                        <select name="bulkaction" id="bulkaction">
                                                            <option value="" selected="selected"><?php _e('No action', 'add-slider'); ?></option>
                                                            <option value="delete_all"><?php _e('Delete all', 'add-slider'); ?></option>
                                                        </select>
                                                    ...
                                                    <table cellspacing="0" class="widefat fixed">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="manage-column" style="width:210px" scope="col"><?php _e('Filename', 'add-slider'); ?></th>
                                                                <th class="manage-column" scope="col"><?php _e('Title', 'add-slider'); ?> / <?php _e('Content', 'add-slider'); ?></th>
                                                                <th class="manage-column" scope="col"><?php _e('URL', 'add-slider'); ?></th>
                                                                <th class="manage-column column-rating" scope="col"><?php _e('Order', 'add-slider'); ?></th>
                                                                <th class="manage-column column-rating" scope="col"><?php _e('Status', 'add-slider'); ?></th>
                                                                <th class="manage-column column-visible" scope="col"><?php _e('Action', 'add-slider'); ?></th>
                                                            </tr>
                                                        </thead>
                                                        <tfoot>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr style="display:none;" valign="top" id="new-slide-element">
                                                                ...
                                                                <td><input name="url[0]" type="text" value="http://" style="width: 95%; margin-bottom: 2px;"><br/><?php _e('Target', 'add-slider'); ?>: <?php
                                                $arr_target = array(
                                                    '_blank' => 'blank',
                                                    '_parent' => 'parent',
                                                    '_self' => 'self'
    ...
    ?></td>
                ...
                <?php foreach ($slider_elements as $element): ?>
                                                        <tr valign="top" id="slide-element-<?php echo $element['id']; ?>">
                                                            ...
                                                            <td><input name="url[<?php echo $element['id']; ?>]" type="text" value="<?php echo ($element['url'] == '') ? 'http://' : $element['url']; ?>" style="width: 95%; margin-bottom: 2px;"><br/><?php _e('Target', 'add-slider'); ?>: <?php
                                                        $arr_target = array(
                                                            '_blank' => 'blank',
                                                            '_parent' => 'parent',
                                                            '_self' => 'self'
                ...
                ?></td>
                                                    <td><a onclick="return deleteSlide('<?php _e('Delete this slider?', 'add-slider'); ?>')" href="<?php echo str_replace('&delete_id='.$_GET['delete_id'],'',$_SERVER['REQUEST_URI']);?>&delete_id=<?php echo $element['id'];?>"><?php _e('Delete', 'add-slider'); ?></a></td>
                                                </tr>
                <?php endforeach; ?>
                <?php else: ?>
                                                            <tr><td colspan="7"><?php _e('There are no slides yet', 'add-slider'); ?></td></tr>
                <?php endif; ?>
                                                        </tbody>
                                                    </table>
                                                    <div class="submit">
                                                        <input type="submit" value="<?php _e('Save Changes','add-slider'); ?>" class="button-primary action">
                                                    </div>
                                                </form>
...
?>
                                                                <div class="updated fade" id="message"><p><strong><?php _e('Options saved.','add-slider'); ?></strong></p></div>
<?php endif; ?>
                                                                <div class="wrap">
                                                                    <h2>Add Slider</h2>
<p>Add Slider a jQuery based image slide show script that can display specific images on your WordPress based website with a lots of transition effects. For this purpose it uses the jQuery's plugin jQuery Cycle.</p>
                                                                    ...
                                                                    <form accept-charset="utf-8" action="admin.php?page=add-slider/add-slider.php" method="POST">
                                                                        <div class="tablenav">
                                                                            <div class="alignleft actions">
                                                                                ...
                                                                                <input type="button" value="<?php _e('Add new slider','add-slider'); ?>" onclick="showAddSlider(); return false;" class="button-primary action" name="doaction">
                                                                            </div>
                                                                        ...
                                                                        <table cellspacing="0" class="widefat">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th scope="col">ID</th>
                                                                                    <th scope="col"><?php _e('Name', 'add-slider'); ?></th>
                                                                                    <th scope="col">Key</th>
                                                                                    <th scope="col"><?php _e('Action', 'add-slider'); ?></th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tfoot>
                                                                                <tr>
                ...
                <?php foreach ($sliders as $slider): ?>
                                                                        <tr id="slider-<?php $slider['id']; ?>">
                                                                            ...
                                                                            <td><a title="Modifier" class="edit" href="?page=add-slider/add-slider.php&controller=manage-slider&action=edit&slider_id=<?php echo $slider['id']; ?>"><?php echo $slider['name']; ?></a></td>
                                                                            <td><?php echo $slider['key']; ?></td>
                                                                            <td>
                                                                                <a onclick="return deleteSlide('<?php _e('Delete this slider?', 'add-slider'); ?>')" href="<?php echo str_replace('&delete_id='.$_GET['delete_id'],'',$_SERVER['REQUEST_URI']);?>&delete_id=<?php echo $slider['id']; ?>"><?php _e('Delete', 'add-slider'); ?></a>
                                                                            </td>
                                                                        </tr>
                <?php endforeach; ?>
                <?php else: ?>
                                                                            <tr><td colspan="5"><?php _e('There are not sliders yet', 'add-slider'); ?></td></tr>
                <?php endif; ?>
                                                                        </tbody>
                                                                    </table>
